...
export const validateCoupon = async (req: Request, res: Response) => {
  ...
  try {
    ...
    if (coupon.applicableToProducts) {
      const applicableProducts: number[] = coupon.applicableToProducts as any;
      const match = productIds.some((id: number) =>
    ...
    if (coupon.applicableToCategories) {
      const applicableCategories: number[] =
        coupon.applicableToCategories as any;
      const match = categoryIds.some((id: number) =>
